 ...
 */
public class RecommedDancingAdapter extends BaseAdapter {
    private AllBean allBean;
    private Context context;

    public RecommedDancingAdapter(Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        AllBean.ResultBean.BodyBean bean = allBean.getResult().get(5).getBody().get(i);
        DancingHolder holder = null;
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_recommend_music, viewGroup, false);
            holder = new DancingHolder(view);
            view.setTag(holder);
        } else {
            holder = (DancingHolder) view.getTag();
        }
    ...
    class DancingHolder {
        ...
        private DancingHolder(View view) {
